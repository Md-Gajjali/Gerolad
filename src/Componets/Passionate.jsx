            ...
            <Container>
                <Flex className='justify-between py-30 '>
                    ...
                    <div className='w-157.5'>
                        ...
                        <p className=' text-justify text-gray-400'>This encompasses a variety of strategies, including search
                            engine optimization (SEO), content marketing, social media
                            marketing, email marketing,.</p>
                        <Flex className='mt-8 justify-between bg-[#8850f72c] shadow py-6 px-5 rounded-sm'>
